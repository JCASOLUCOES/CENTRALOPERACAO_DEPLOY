...
- **Rotas/endpoints/tabelas:** `/implantacao/kanban?perfil=F`; `GET /api/v1/implantacao/tarefas?perfilId=F&perfilModo=excluir`, além dos endpoints de colunas/projetos/operadores do Kanban; `tbtarefa`, `tbprojeto`, `tbcoluskananban` e `tboperador`.

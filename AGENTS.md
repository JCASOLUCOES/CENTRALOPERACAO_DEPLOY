...
Detalhes em `README.md` (raiz) e `CENTRALOPERACAO_FRONTEND/docs/DEPLOY.md` § 7.
...
- **Alterações de código** (Angular em `CENTRALOPERACAO_FRONTEND/src`, backend em `CENTRALOPERACAO_BACKEND`, skills, agentes, scripts de deploy):
  ...
  - `CENTRALOPERACAO_BACKEND/README.md` (se existir)
...
- **Alterações no fluxo de branches / deploy / versionamento**:
  atualizar `README.md` da raiz, `CENTRALOPERACAO_FRONTEND/README.md`,
  `CENTRALOPERACAO_BACKEND/README.md`, `DEPLOY.md` § 7, `DOCUMENTACAO-COMPLETA.md`
